...
|                                                                              光学-红外                                                                              |                                                                                      光学-SAR                                                                                       |
|:---------------------------------------------------------------------------------------------------------------------------------------------------------------:|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------:|
| ![光学-红外匹配效果图](assets/result_opt_inf_1.png)<br>基准图: RoadScene/inf/FLIR_05027.jpg<br>实时图: RoadScene/opt/FLIR_05027.jpg<br>模拟变换: 旋转-30°<br>正确匹配点数 / 内点数: 420 / 422 | ![光学-SAR匹配效果图](assets/result_opt_sar_1.png)<br>基准图: OSdataset/opt/10.png<br>实时图: OSdataset/sar/10.png<br>模拟变换: 旋转15°, 尺度1.2倍, x方向透视收缩5e-4, y方向透视收缩5e-4<br>正确匹配点数 / 内点数: 380 / 380 |

|                                                                                       光学-地图                                                                                       |                                                                                      光学-深度                                                                                      |
|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------:|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------:|
| ![光学-地图匹配效果图](assets/result_opt_map.png)<br>基准图: VMGGA-Opt-Map/map/109747_53549.jpg<br>实时图: VMGGA-Opt-Map/opt/109747_53549.jpg<br>模拟变换: 旋转-15°, 尺度1.1倍<br>正确匹配点数 / 内点数: 216 / 227 | ![光学-深度匹配效果图](assets/result_opt_dep_1.png)<br>基准图: NYU-DEPTH-V2/depth/1340.jpg<br>实时图: NYU-DEPTH-V2/opt/1340.jpg<br>模拟变换: 旋转10°, 尺度1.1倍, x方向透视收缩1e-5<br>正确匹配点数 / 内点数: 227 / 230 |
